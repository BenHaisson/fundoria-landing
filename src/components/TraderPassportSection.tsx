        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          ...
          >
            <SectionHeader
              ...
              subtitle="The Trader Passport is the core social object of Fundoria. It turns live Hyperliquid activity into a shareable reputation profile that traders use to prove skill, build status, and become discoverable by capital providers."
              className="mb-8"
            />
