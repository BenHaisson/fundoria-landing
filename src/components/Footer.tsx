    ...
    <>
      ...
      <section className="relative py-24 sm:py-36 lg:py-44 px-4 sm:px-6 text-center border-t border-protocol-border bg-protocol-bg overflow-hidden transition-colors duration-300">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-175 h-100 bg-green/5 rounded-full blur-[120px]" />
          <div className="absolute top-1/2 left-1/3 -translate-y-1/2 w-75 h-75 bg-blue/5 rounded-full blur-[80px]" />
        </div>
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 sm:gap-5 px-4 sm:px-0"
          >
            <button
