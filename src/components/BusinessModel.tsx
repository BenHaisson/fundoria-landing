...
const tiers = [
  ...
  },
  {
    ...
    num: '03',
    title: 'Partner Competitions',
    sub: 'Event Revenue',
    desc: 'Sponsored competitions, partner campaigns, and seasonal challenge access with verifiable public results.',
    tag: 'Per Season',
    tagColor: 'text-blue border-blue/30 bg-blue/5',
    color: 'text-blue',
  },
  {
    ...
    sub: 'Platform Fee',
    desc: 'Dashboard access for allocators to filter, discover, and watch verified traders. Platform access fees for discovery tools, analytics, and future matching workflows.',
    tag: 'Platform Fee',
    tagColor: 'text-green border-green/30 bg-green/5',
    color: 'text-green',
  },
